...
1. Download the latest stable version of the plugin from the [releases page](https://github.com/srkgupta/mattermost-plugin-dependency-track/releases)
...
To update the plugin repeat the [Installing the plugin](https://github.com/srkgupta/mattermost-plugin-dependency-track#installing-the-plugin) step.
